 ...
 * @author juanj
 */
public class ModalProveedor extends javax.swing.JDialog {

    /**
     * Creates new form ModalProveedor
     */
    public ModalProveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void guardarUsuario(String nombre) throws SQLException {
        ...
        if (!nombre.isEmpty()) {
            int confirmado = JOptionPane.showConfirmDialog(
                    null, "¿Seguro que quiere guardar a " + nombre + " como proveedor?");
            if (JOptionPane.OK_OPTION == confirmado) {
                boolean bandera = proveedor.agregarProveedor(nombre);
                if (bandera) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModalProveedor dialog = new ModalProveedor(new javax.swing.JFrame(), true);
