 ...
 * @author juanj
 */
public class Frm_EditarCompras extends javax.swing.JFrame {
     ...
     */
    public Frm_EditarCompras() throws SQLException, ParseException {
        initComponents();
        llenarTabla();
        activarPanel(false);
    }
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(jPanel8, javax.swing.GroupLayout.PREFERRED_SIZE, 653, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
    ...
    private void btnEditarCancelarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarCancelarMouseClicked
        try {
            ...
            Logger.getLogger(Frm_EditarCompras.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ParseException ex) {
            Logger.getLogger(Frm_EditarCompras.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void llenarCmbs() throws SQLException {
        ...
        conProductos.llenarCMBProductos(cmbProductos,"compras");
    }
    ...
    private void editarRegistro() throws ParseException {
        ...
        double kilos = (producto.equalsIgnoreCase("gastos")?0:Double.parseDouble(txtKilos.getText().toString()));
